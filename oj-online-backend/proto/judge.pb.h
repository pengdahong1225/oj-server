...
class SSJudgeRequest :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 submit_id() const;
  void set_submit_id(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_submit_id() const;
  void _internal_set_submit_id(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 submit_id_;
...
inline ::PROTOBUF_NAMESPACE_ID::int64 SSJudgeRequest::_internal_submit_id() const {
  return submit_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 SSJudgeRequest::submit_id() const {
  // @@protoc_insertion_point(field_get:SSJudgeRequest.submit_id)
  return _internal_submit_id();
}
inline void SSJudgeRequest::_internal_set_submit_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  submit_id_ = value;
}
inline void SSJudgeRequest::set_submit_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void SSJudgeResponse::set_session_id(const std::string& value) {
  _internal_set_session_id(value);
...
inline void SSJudgeResponse::set_session_id(std::string&& value) {
  
  session_id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:SSJudgeResponse.session_id)
}
inline void SSJudgeResponse::set_session_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  session_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:SSJudgeResponse.session_id)
}
inline void SSJudgeResponse::set_session_id(const char* value, size_t size) {
  
  session_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:SSJudgeResponse.session_id)
}
