...
type DBServiceClient interface {
	...
	CreateUserSubmitRecord(ctx context.Context, in *CreateUserSubmitRecordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// comment接口
...
func (c *dBServiceClient) CreateUserSubmitRecord(ctx context.Context, in *CreateUserSubmitRecordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, DBService_CreateUserSubmitRecord_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) QueryComment(ctx context.Context, in *QueryCommentRequest, opts ...grpc.CallOption) (*QueryCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, DBService_QueryComment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DBServiceServer interface {
	...
	CreateUserSubmitRecord(context.Context, *CreateUserSubmitRecordRequest) (*emptypb.Empty, error)
	// comment接口
...
func (UnimplementedDBServiceServer) CreateUserSubmitRecord(context.Context, *CreateUserSubmitRecordRequest) (*emptypb.Empty, error) {
