...
func (x *Problem) GetCreateAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateAt
	}
	return nil
...
func (x *Problem) GetDeleteAt() *timestamppb.Timestamp {
	if x != nil {
		return x.DeleteAt
	}
	return nil
...
var file_problem_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x63, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b,
...
var file_problem_proto_depIdxs = []int32{
	3, // 0: Problem.create_at:type_name -> google.protobuf.Timestamp
	3, // 1: Problem.delete_at:type_name -> google.protobuf.Timestamp
