...
var file_rpc_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xd7, 0x05, 0x0a, 0x09, 0x44, 0x42, 0x53, 0x65, 0x72, 0x76,
...
var file_rpc_proto_goTypes = []interface{}{
	...
	(*Question)(nil),                    // 19: Question
	(*SubmitRecord)(nil),                // 20: SubmitRecord
	(*empty.Empty)(nil),                 // 21: google.protobuf.Empty
}
var file_rpc_proto_depIdxs = []int32{
	18, // 0: GetUserResponse.data:type_name -> UserInfo
	18, // 1: CreateUserRequest.data:type_name -> UserInfo
	18, // 2: UpdateUserRequest.data:type_name -> UserInfo
	18, // 3: GetUserListResponse.data:type_name -> UserInfo
	19, // 4: GetQuestionResponse.data:type_name -> Question
	19, // 5: CreateQuestionRequest.data:type_name -> Question
	19, // 6: UpdateQuestionRequest.data:type_name -> Question
	19, // 7: GetQuestionListResponse.data:type_name -> Question
	20, // 8: GetUserSubmitRecordResponse.data:type_name -> SubmitRecord
	0,  // 9: DBService.GetUserData:input_type -> GetUserRequest
	2,  // 10: DBService.CreateUserData:input_type -> CreateUserRequest
	4,  // 11: DBService.UpdateUserData:input_type -> UpdateUserRequest
	5,  // 12: DBService.DeleteUserData:input_type -> DeleteUserRequest
	6,  // 13: DBService.GetUserList:input_type -> GetUserListRequest
	8,  // 14: DBService.GetQuestionData:input_type -> GetQuestionRequest
	10, // 15: DBService.CreateQuestionData:input_type -> CreateQuestionRequest
	12, // 16: DBService.UpdateQuestionData:input_type -> UpdateQuestionRequest
	13, // 17: DBService.DeleteQuestionData:input_type -> DeleteQuestionRequest
	14, // 18: DBService.GetQuestionList:input_type -> GetQuestionListRequest
	16, // 19: DBService.GetUserSubmitRecord:input_type -> GetUserSubmitRecordRequest
	1,  // 20: DBService.GetUserData:output_type -> GetUserResponse
	3,  // 21: DBService.CreateUserData:output_type -> CreateUserResponse
	21, // 22: DBService.UpdateUserData:output_type -> google.protobuf.Empty
	21, // 23: DBService.DeleteUserData:output_type -> google.protobuf.Empty
	7,  // 24: DBService.GetUserList:output_type -> GetUserListResponse
	9,  // 25: DBService.GetQuestionData:output_type -> GetQuestionResponse
	11, // 26: DBService.CreateQuestionData:output_type -> CreateQuestionResponse
	21, // 27: DBService.UpdateQuestionData:output_type -> google.protobuf.Empty
	21, // 28: DBService.DeleteQuestionData:output_type -> google.protobuf.Empty
	15, // 29: DBService.GetQuestionList:output_type -> GetQuestionListResponse
	17, // 30: DBService.GetUserSubmitRecord:output_type -> GetUserSubmitRecordResponse
