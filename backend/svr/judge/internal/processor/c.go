...
func (cp *CProcessor) Compile(param *biz.Param) (*biz.SandBoxApiResponse, error) {
	form := biz.SandBoxApiForm{
		...
		Args:        []string{"/usr/bin/gcc", "main.c", "-o", "main"},
...
func (cp *CProcessor) Run(param *biz.Param) {
