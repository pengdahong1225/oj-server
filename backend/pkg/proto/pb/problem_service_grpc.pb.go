...
const (
	...
	ProblemService_HideProblem_FullMethodName      = "/ProblemService/HideProblem"
...
type ProblemServiceClient interface {
	...
	// 隐藏题目
	HideProblem(ctx context.Context, in *HideProblemRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 更新题目信息
	UpdateProblem(ctx context.Context, in *UpdateProblemRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 删除题目
...
func (c *problemServiceClient) HideProblem(ctx context.Context, in *HideProblemRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ProblemService_HideProblem_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *problemServiceClient) UpdateProblem(ctx context.Context, in *UpdateProblemRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type ProblemServiceServer interface {
	...
	// 隐藏题目
	HideProblem(context.Context, *HideProblemRequest) (*emptypb.Empty, error)
	// 更新题目信息
	UpdateProblem(context.Context, *UpdateProblemRequest) (*emptypb.Empty, error)
	// 删除题目
...
func (UnimplementedProblemServiceServer) HideProblem(context.Context, *HideProblemRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HideProblem not implemented")
}
func (UnimplementedProblemServiceServer) UpdateProblem(context.Context, *UpdateProblemRequest) (*emptypb.Empty, error) {
...
func _ProblemService_HideProblem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HideProblemRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProblemServiceServer).HideProblem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProblemService_HideProblem_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProblemServiceServer).HideProblem(ctx, req.(*HideProblemRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProblemService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HideProblem",
			Handler:    _ProblemService_HideProblem_Handler,
		},
		{
