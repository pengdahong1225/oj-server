...
func (r ProblemHandler) UpdateQuestion(ctx *gin.Context) {
	...
	res := r.logic.HandleUpdateQuestion(claims.Uid, form)
	ctx.JSON(http.StatusOK, res)
}

func (r ProblemHandler) DeleteQuestion(ctx *gin.Context) {
	...
	res := r.logic.HandleDelQuestion(problemID)
	ctx.JSON(http.StatusOK, res)
}
