...
const file_problem_service_proto_rawDesc = "" +
	...
	"\x06output\x18\x02 \x01(\tR\x06output\"\x92\x01\n" +
	...
	"\x13UploadConfigRequest\x12\x16\n" +
	"\x06config\x18\x01 \x01(\fR\x06config\">\n" +
	"\x14UploadConfigResponse\x12\x0e\n" +
	...
	"\x04data\x18\x01 \x01(\v2\r.SubmitRecordR\x04data2\xae\x06\n" +
	"\x0eProblemService\x12>\n" +
	"\rCreateProblem\x12\x15.CreateProblemRequest\x1a\x16.CreateProblemResponse\x12;\n" +
	"\fUploadConfig\x12\x14.UploadConfigRequest\x1a\x15.UploadConfigResponse\x12A\n" +
	...
	"\x13GetSubmitRecordData\x12\x17.GetSubmitRecordRequest\x1a\x18.GetSubmitRecordResponseB\aZ\x05./;pbb\x06proto3"
